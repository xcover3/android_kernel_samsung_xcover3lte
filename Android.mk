...
ifeq ($(TARGET_SOC),pxa1936)
	$(KERNEL_SCRIPT_UPDATE) --set-val NR_CPUS 8
	...
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_CPU_FREQ
	$(KERNEL_SCRIPT_UPDATE) -d ARM_MMP_SMP_CPUFREQ
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_CPU_THERMAL
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_PXA1928_THERMAL
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_HELAN2_THERMAL
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_PXA1936_THERMAL
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_PXA_DVFS
	$(KERNEL_SCRIPT_UPDATE) -d CONFIG_PM_DEVFREQ
	$(KERNEL_SCRIPT_UPDATE) -e PXA1936_CLK
