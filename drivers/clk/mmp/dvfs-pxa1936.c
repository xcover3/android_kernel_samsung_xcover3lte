...
static unsigned long freqs_cmb_1936[VM_RAIL_MAX][VL_MAX] = {
	...
	/* CLST0 */
	{ 312000, 416000, 624000, 624000, 832000, 1057000, 1057000, 1248000 },
	/* CLST1 */
	{ 312000, 416000, 832000, 1057000, 1248000, 1248000, 1526000, 1595000 },
	/* DDR */
...
static int vm_millivolts_1936_svcumc[][VL_MAX] = {
	/*LV0, LV1,  LV2,  LV3,  LV4,  LV5,  LV6,  LV7  */
	{975, 1038,  1125, 1150, 1200, 1300, 1300, 1300},/* Profile0 */
	{975,  975,  1000, 1000, 1050, 1113, 1138, 1200},/* Profile1 */
	{975,  975,  1000, 1000, 1050, 1125, 1150, 1213},/* Profile2 */
	{975,  975,  1000, 1000, 1050, 1138, 1150, 1225},/* Profile3 */
	{975,  975,  1000, 1013, 1063, 1150, 1163, 1238},/* Profile4 */
	{975,  975,  1000, 1013, 1063, 1150, 1163, 1238},/* Profile5 */
	{975,  975,  1000, 1025, 1075, 1163, 1175, 1250},/* Profile6 */
	{975,  975,  1013, 1038, 1075, 1175, 1188, 1263},/* Profile7 */
	{975,  975,  1013, 1038, 1088, 1175, 1188, 1263},/* Profile8 */
	{975,  975,  1025, 1050, 1088, 1188, 1200, 1275},/* Profile9 */
	{975,  975,  1050, 1075, 1125, 1200, 1225, 1300},/* Profile10 */
	{975,  975,  1050, 1075, 1125, 1225, 1225, 1300},/* Profile11 */
	{975,  988,  1075, 1100, 1150, 1250, 1250, 1300},/* Profile12 */
...
static unsigned long freqs_cmb_1936_tsmc[VM_RAIL_MAX][VL_MAX] = {
	...
	/* DDR */
	{ 312000,  312000, 528000, 528000, 528000, 624000, 667000, 797000},
	/* AXI */
	{ 208000,  208000, 208000, 312000, 312000, 312000, 312000, 312000 },
	/* GC3D */
	{      0,  312000, 312000, 624000, 624000, 832000, 832000, 832000 },
	/* GC2D */
	{      0,  208000, 208000, 312000, 312000, 416000, 416000, 416000 },
	/* GCSHADER */
	{      0,  312000, 312000, 624000, 624000, 832000, 832000, 832000 },
	/* GC ACLK */
	{      0,  312000, 312000, 416000, 416000, 416000, 528000, 528000 },
	/* VPU */
	{ 208000,  312000, 416000, 416000, 528000, 528000, 528000, 528000 },
	/* ISP */
	{      0,  208000, 312000, 312000, 312000, 499000, 499000, 499000 },
	/* SDH0 dummy dvfs clk*/
	{ DUMMY_VL_TO_KHZ(0), DUMMY_VL_TO_KHZ(1), DUMMY_VL_TO_KHZ(2), DUMMY_VL_TO_KHZ(3),
	  DUMMY_VL_TO_KHZ(4), DUMMY_VL_TO_KHZ(5), DUMMY_VL_TO_KHZ(6), DUMMY_VL_TO_KHZ(7)
	},
...
static int vm_millivolts_1936_svc_tsmc[][VL_MAX] = {
	/*LV0, LV1,  LV2,  LV3,  LV4,  LV5,  LV6,  LV7  */
	{975,  1038, 1075, 1125, 1150, 1200, 1275, 1300},/* Profile0 */
	{975,  988,   988, 1000, 1000, 1038, 1050, 1175},/* Profile1 */
	{975,  988,   988, 1000, 1000, 1038, 1063, 1188},/* Profile2 */
	{975,  988,   988, 1000, 1000, 1050, 1063, 1200},/* Profile3 */
