...
struct mmp_pd_gc3d {
	...
	const struct mmp_pd_gc3d_data *data;
};

static struct mmp_pd_gc3d_data gc3d_data = {
	.id			= 0,
...
{
	struct mmp_pd_gc3d *pd = container_of(domain,
			struct mmp_pd_gc3d, genpd);
