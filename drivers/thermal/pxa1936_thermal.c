		...
		unsigned long state)
{
	...
	pr_info("Thermal cpu temp %dC, state %lu, cluster0freq qos %lu, cluster1freq qos %lu,core_num qos %lu\n",
		temp / 1000, state, cluster0_freq_state, cluster1_freq_state, plug_state);
