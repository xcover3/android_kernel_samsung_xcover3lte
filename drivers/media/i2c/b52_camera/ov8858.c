...
#include "ov8858.h"
/*static int OV8858_get_mipiclock(struct v4l2_subdev *sd, u32 *rate, u32 mclk)
{
	return 0;
}*/
...
/*static void OV8858_write_i2c(struct b52_sensor *sensor, u16 reg, u8 val)
{
	b52_sensor_call(sensor, i2c_write, reg, val, 1);
}
static u8 OV8858_read_i2c(struct b52_sensor *sensor, u16 reg)
{
	int temp1;
	b52_sensor_call(sensor, i2c_read, reg, &temp1, 1);
	return temp1;
}
static int OV8858_OTP_access_start(struct b52_sensor *sensor)
{
	return 0;
}
static int OV8858_OTP_access_end(struct b52_sensor *sensor)
{
	return 0;
}
